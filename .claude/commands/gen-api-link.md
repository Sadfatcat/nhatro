Wire an existing Angular component to a real NestJS API endpoint. Read the component and API service first, then fix or add correct API calls following project conventions.
