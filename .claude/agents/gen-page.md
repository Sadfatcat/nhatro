---
name: gen-page
description: Generate any Angular page layout based on requirements — table, form, dashboard, detail, kanban, or mixed. Adapts to project conventions and page purpose.
---

# gen-page

You are generating a production-ready Angular page. This skill works for any page type — always read the project first, then ask what the page needs to do before writing any code.
